      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse ">
          <ul class="nav navbar-nav pull-right">
              <li><a href="/mvc/login">Log-in</a></li>
            <li class="active"><a href="/mvc/registration">Registration</a></li>
            <li><a href="/mvc/weather">Weather</a></li>
            <li><a href="/mvc/feedback/add">Feedback</a></li>
            <li><a href="/mvc/feedback">Reviews</a></li>
